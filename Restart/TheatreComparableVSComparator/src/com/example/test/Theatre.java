...
/**
 * We are gonna set a price of $12 for seats but if the seats are near the middle
 * of the first three rows the price increases to 14 and seats in the back two rows
 * are on the edges of the theater only cost $7
 */
