...
public class Main {
	...
	// write your code here
        ...
        1) Create a class and name it LAMP.Inside this class should be declared three member
           variables: style of type String, battery of type boolean, and globalRating of type int.
           All variables should be marked private.A constructor needs to be created whch accepts
           ...
           getStyle() returns the lamp style, isBattery returns the value of battery, and getGlobalRating()
           returns the globalRating of the lamp.

        2) Create a class and name it BED. Five private member variables should be declared: style of
           type String, and pillows, height, sheets, quilt of type int. A constructor should be coded
           which accepts these five member variables as parameters.Also, six methods should be defined:
        ...
        3) Create a class and name it CEILING. There are two member variables for this one, height and
        ...
        name of type String: wall1, wall2, wall3, wall4 of type Wall; ceiling if type Ceiling; bed of
        type Bed, and lamp of type Lamp. The class constructor should accept all eight of the member variables
